...
def get_paths(path, name='coco', use_restval=True):
    ...
    if name=='custom':
        ...
        if 'coco' == name:
            ...
            capdir = '/content/drive/MyDrive/coco/COCO_annotations'
            roots['train'] = {
...
def get_loader_single(data_name, split, root, json, vocab, transform,
                                            ...
                                            ids=None, opt=None, json_list=None):
    """Returns torch.utils.data.DataLoader for custom coco dataset.
    if data_name== custom, it needs root=image_root and json_list
